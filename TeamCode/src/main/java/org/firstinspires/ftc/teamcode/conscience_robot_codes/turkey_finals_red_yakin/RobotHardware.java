...
public class RobotHardware {
    ...
    private final double TURN_GAIN = 0.5; // P-Gain (Kp)
    private final double DERIVATIVE_GAIN = 0.35;    // D-Gain (Kd)
    private final double INTEGRAL_GAIN = 0.1; // I-Gain (Ki)
    ...
    public boolean updateAngularAlignment(AprilTagDetection target) {
        ...
        double headingError = target.ftcPose.bearing - 1.5;
